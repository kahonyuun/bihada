...
/**
 The base class for all bihada modules
 */
...
/**
 bihada Platform calls this method on startup.
 */
-(void)startup;

/**
 bihada Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 bihada Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 bihada Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 bihada Platform calls this method on resume.
 @param sender The sender of the event.
 */
