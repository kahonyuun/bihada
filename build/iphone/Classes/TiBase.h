...
// in simulator we redefine to format for bihada Developer console
...
{\
	NSString * exceptionName = [@"org.bihada." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.bihada";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIbihadaNativeItemNone = -1, 
	UIbihadaNativeItemSpinner = -2,
	UIbihadaNativeItemProgressBar = -3,
	
	UIbihadaNativeItemSlider = -4,
	UIbihadaNativeItemSwitch = -5,
	UIbihadaNativeItemMultiButton = -6,
	UIbihadaNativeItemSegmented = -7,
	
	UIbihadaNativeItemTextView = -8,
	UIbihadaNativeItemTextField = -9,
	UIbihadaNativeItemSearchBar = -10,
	
	UIbihadaNativeItemPicker = -11,
	UIbihadaNativeItemDatePicker = -12,
	
	UIbihadaNativeItemInfoLight = -13,
	UIbihadaNativeItemInfoDark = -14,
	
	UIbihadaNativeItemDisclosure = -15,
	
	UIbihadaNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all bihada instances of
